...
public class NotificacaoUsuarioService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        while(true) {
            ...
            Log.i(getClass().getName(), "Dentro do onHandleIntent, id do usuario = " + idUsuario);

            List<Notificacao> listaNotificacao = notificacaoRepository.getNotificacoesUsuario(1);
