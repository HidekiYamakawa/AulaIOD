...
public class NotificacaoRepository {
    ...
    public List<Notificacao> getNotificacoesUsuario(long id) {
        try {
            ...
            Response<List<Notificacao>> repostaRemota = chamadaRemota.execute();
            List<Notificacao> listaNotificacoesUsuario = repostaRemota.body();
            ...
            for (Notificacao notificacao : listaNotificacoesUsuario) {
                try {
                    ...
                    Log.d(getClass().getName(), "Recebemos uma notificacao nova!!");
